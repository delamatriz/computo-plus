// Completa los 2 APUs estándar faltantes de Subcontratos - Cortinas de
// Enrollar (PVC y aluminio poliuretánica) en la base de PRODUCCIÓN.
// Ejecutar: DATABASE_URL="postgresql://..." npx tsx scripts/seed-apus-cortinas-enrollar.ts
...
const APUS: ApuDef[] = [
  {
    codigo: "7.5.1",
    descripcion: "CORTINA DE ENROLLAR DE PVC COMPLETA",
    capituloFallback: "Cortinas de Enrollar",
    materiales: [
      { descripcion: "Cortina de enrollar PVC", unidad: "m2", rendimiento: 1.05 },
      { descripcion: "Cajón para cortina de enrollar", unidad: "ml", rendimiento: 0.8 },
    ],
    manoObra: [
  ...
  {
    codigo: "7.5.2",
    descripcion: "CORTINA DE ENROLLAR DE ALUMINIO CON RELLENO POLIURETÁNICO",
    capituloFallback: "Cortinas de Enrollar",
    materiales: [
      { descripcion: "Cortina de enrollar aluminio poliuretánica", unidad: "m2", rendimiento: 1.05 },
      { descripcion: "Cajón para cortina de enrollar", unidad: "ml", rendimiento: 0.8 },
    ],
    manoObra: [
      { categoria: "Oficial especializado", jornadaHs: 8, rendimiento: 3.5 },
    ],
  },
];
