// Completa el APU estándar faltante de Demoliciones y Picados
// (demolición de muro de hormigón armado) en la base de PRODUCCIÓN.
// Ejecutar: DATABASE_URL="postgresql://..." npx tsx scripts/seed-apus-demoliciones-2.ts
...
const APUS: ApuDef[] = [
  {
    codigo: "manual-b89aa8fb-9d29-48f6-93c9-b1b8251d37b5",
    descripcion: "DEMOLICIÓN DE MURO DE HORMIGÓN ARMADO",
    capituloFallback: "Demolic",
    materiales: [],
    manoObra: [
