// Completa los 7 APUs estándar faltantes de Subcontratos - Vidrios
// (incoloro, esmerilado, templado y espejos) en la base de PRODUCCIÓN.
// Ejecutar: DATABASE_URL="postgresql://..." npx tsx scripts/seed-apus-vidrios.ts
...
const APUS: ApuDef[] = [
  {
    codigo: "7.4.1",
    descripcion: "VIDRIO INCOLORO DE 4mm",
    capituloFallback: "Vidrios",
    materiales: [
      { descripcion: "Vidrio incoloro 4mm", unidad: "m2", rendimiento: 1.05 },
      { descripcion: "Sellador silicona", unidad: "u", rendimiento: 0.1 },
    ],
    manoObra: [
  ...
  {
    codigo: "7.4.2",
    descripcion: "VIDRIO INCOLORO DE 5mm",
    capituloFallback: "Vidrios",
    materiales: [
      { descripcion: "Vidrio incoloro 5mm", unidad: "m2", rendimiento: 1.05 },
      { descripcion: "Sellador silicona", unidad: "u", rendimiento: 0.1 },
    ],
    manoObra: [
      { categoria: "Oficial especializado", jornadaHs: 8, rendimiento: 11 },
    ],
  },
  {
    codigo: "7.4.3",
    descripcion: "VIDRIO ESMERILADO INCOLORO DE 4mm",
    capituloFallback: "Vidrios",
    materiales: [
      { descripcion: "Vidrio esmerilado incoloro 4mm", unidad: "m2", rendimiento: 1.05 },
      { descripcion: "Sellador silicona", unidad: "u", rendimiento: 0.1 },
    ],
    manoObra: [
  ...
  },
  {
    ...
    capituloFallback: "Vidrios",
    materiales: [
      { descripcion: "Vidrio templado 6mm", unidad: "m2", rendimiento: 1.05 },
      { descripcion: "Sellador silicona", unidad: "u", rendimiento: 0.12 },
    ],
    manoObra: [
  ...
  {
    codigo: "7.4.5",
    descripcion: "VIDRIO TEMPLADO DE 8mm",
    capituloFallback: "Vidrios",
    materiales: [
      { descripcion: "Vidrio templado 8mm", unidad: "m2", rendimiento: 1.05 },
      { descripcion: "Sellador silicona", unidad: "u", rendimiento: 0.12 },
    ],
    manoObra: [
  ...
  {
    codigo: "7.4.7",
    descripcion: "ESPEJO DE 3mm CON COLOCACIÓN",
    capituloFallback: "Vidrios",
    materiales: [
      { descripcion: "Espejo 3mm", unidad: "m2", rendimiento: 1.05 },
      { descripcion: "Adhesivo para espejo", unidad: "kg", rendimiento: 0.3 },
    ],
    manoObra: [
      { categoria: "Oficial especializado", jornadaHs: 8, rendimiento: 10 },
    ],
  ...
  {
    codigo: "7.4.8",
    descripcion: "ESPEJO DE 4mm SIN COLOCACIÓN",
    capituloFallback: "Vidrios",
    materiales: [
      { descripcion: "Espejo 4mm", unidad: "m2", rendimiento: 1.05 },
    ],
    manoObra: [],
  },
];
